...
import 'package:clones_desktop/ui/components/modals/tool_status_modal.dart';
...
class ModalsManagement extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final showToolStatusModal = ref.watch(toolStatusModalProvider);
    ...
    return ClipRect(
      child: Stack(
        children: [
          ...
          if (showToolStatusModal) const ToolStatusModal(),
